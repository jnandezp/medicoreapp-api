...
type UserService interface {
	CreateUser(name, email, password string) (*entities.User, error)
	GetAllUsers() ([]entities.User, error)
	GetUserByID(id uint) (*entities.User, error)
	UpdateUser(id uint, name string) (*entities.User, error)
...
func (s *userService) UpdateUser(id uint, name string) (*entities.User, error) {
